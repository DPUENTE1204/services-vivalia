...
<table class="table table-bordered">
            ...
            <tr>    
                ...
                <td>
                <a href="edit2.php?idservicio=<?php echo $row['idservicio']?>" class="btn btn-secondary">
                    <i class="fas fa-marker"></i>
                </a>
                <br>
                <br>
                <a href="delete_task2.php?idservicio=<?php echo $row['idservicio']?>" class="btn btn-danger">
